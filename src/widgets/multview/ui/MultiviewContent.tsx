...
export function MultiviewContent() {

  // 선택된 스트리머 목록 (최대 6개까지 표시하도록 설정)
  ...
  // 그리드 컬럼 클래스 동적 설정
  const gridColsClass =
    selectedChannels.length === 1 ? "lg:grid-cols-1" : "lg:grid-cols-2";
  ...
  return (
    <>
      ...
      <div className="w-full min-h-dvh bg-black p-4">
        ...
        {/* 멀티뷰 레이아웃 */}
        <div
          className={`grid grid-cols-1 ${gridColsClass} gap-4 lg:h-[80vh] bg-black`}
        >
